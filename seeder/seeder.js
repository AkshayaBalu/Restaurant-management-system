...
let users = [
    ...
    new User({
        ...
        avatar : "profile.png",
        created_at : ("2023-04-13T13:44:54.420Z")
    })
    ,
    new User({
        ...
        avatar : "profile.png",
        created_at : ("2023-04-13T13:45:59.440Z")
    })
    ,
    new User({
        ...
        avatar : "profile.png",
        created_at : ("2023-04-13T13:46:24.659Z")
    })
    ,
    new User({
        ...
        avatar : "profile.png",
        created_at : ("2023-04-13T13:47:07.391Z")
    })
    ,
    new User({
        ...
        avatar : "profile.png",
        created_at : ("2023-04-13T13:47:46.847Z")
    })
    ,
    new User({
        ...
        avatar : "profile.png",
        created_at : ("2023-04-13T13:48:09.694Z")
    })
    ]
...
let drinks = [
    ...
    new Drink({
            ...
            Type : "newwoman",
            Description : "Prepared by best chefs in the town. Happy Dining!",
...
,
    new Drink({
            ...
            Type : "oldgrills",
            Description : "Prepared by best chefs in the town. Happy Dining!",
            created_at : ("2023-04-13T15:06:46.771Z")
    })
,
    new Drink({
            ...
            Type : "krilline",
            Description : "Prepared by best chefs in the town. Happy Dining!",
            created_at : ("2023-04-15T18:07:20.957Z")
    })
,
    new Drink({
            ...
            Type : "grills",
            Description : "Prepared by best chefs in the town. Happy Dining!",
            created_at : ("2023-04-15T18:07:33.488Z")
    })
,
    new Drink({
            ...
            Type : "children",
            Description : "Prepared by best chefs in the town. Happy Dining!",
            created_at : ("2023-04-15T18:07:46.340Z")
    })
,
    new Drink({
            ...
            Type : "all types",
            Description : "Prepared by best chefs in the town. Happy Dining!",
            created_at : ("2023-04-16T13:32:04.473Z")
    })
]
...
,
    new Food({
        ...
        Category : "jadida",
        Description : "Prepared by best chefs in the town. Happy Dining!",
        created_at : ("2023-04-17T13:55:25.556Z")
    })
,
    new Food({
        ...
        Category : "bagtiha",
        Description : "Prepared by best chefs in the town. Happy Dining!",
        created_at : ("2023-04-17T13:56:17.278Z")
    })
,
    new Food({
        ...
        Category : "gambo",
        Description : "Prepared by best chefs in the town. Happy Dining!",
        created_at : ("2023-04-17T13:55:38.135Z")
    })
,
    new Food({
        ...
        Category : "kira",
        Description : "Prepared by best chefs in the town. Happy Dining!",
        created_at : ("2023-04-17T13:55:34.410Z")
    })
,
    new Food({
        ...
        Category : "taachta",
        Description : "Prepared by best chefs in the town. Happy Dining!",
        created_at : ("2023-04-17T13:55:29.316Z")
    })
]
...
,
    ...
    Type : "lovers",
    Description : "Happy Dining!",
    created_at : ("2023-04-02T15:54:19.023Z")
})
,
new Table({
    ...
    Type : "family",
    Description : "Happy Dining!",
    created_at : ("2023-04-02T15:54:37.815Z")
})
,
new Table({
    ...
    Type : "lovers",
    Description : "Happy Dining!",
    created_at : ("2023-04-03T13:55:47.103Z")
})
,
new Table({
    ...
    NumberPlace : "1",
    Type : "alone",
    Description : "Thank you for the service!",
    created_at : ("2023-04-15T14:28:15.829Z")
})
,
new Table({
    ...
    Type : "family",
    Description : "Happy Dining!",
    created_at : ("2023-04-15T14:38:25.835Z")
})
,
new Table({
    ...
    Type : "family",
    Description : "Prepared by best chefs in the town. Happy Dining!",
    created_at : ("2023-04-15T16:50:12.893Z")
})
,
new Table({
    ...
    Type : "family",
    Description : "Prepared by best chefs in the town. Happy Dining!",
    created_at : ("2023-04-16T13:29:37.889Z")
})
...
let chefs = [
        ...
        created_at : ("2023-04-01T10:04:22.865Z")
    })
    ,
    new Chef({
        ...
        created_at : ("2023-04-01T10:08:08.373Z")
    })
    ,
    new Chef({
        ...
        created_at : ("2023-04-01T10:10:22.363Z")
    })
    ,
    new Chef({
        ...
        created_at : ("2023-04-01T10:10:32.230Z")
    })
    ,
    new Chef({
        ...
        created_at : ("2023-04-01T10:10:44.512Z")
    })
    ,
    new Chef({
        ...
        created_at : ("2023-04-01T10:11:11.177Z")
    })
...
new Waiter({
            ...
            created_at : ("2023-03-31T12:04:09.333Z")
        })
,
new Waiter({
            ...
            created_at : ("2023-03-31T12:08:04.201Z")
        })
,
new Waiter({
            ...
            created_at : ("2023-03-31T12:08:56.224Z")
        })
,
new Waiter({
            ...
            created_at : ("2023-04-15T18:42:49.407Z")
        })
,
new Waiter({
            ...
            created_at : ("2023-04-16T13:49:49.621Z")
    })
...
new Customer({
        ...
        Contact : "02150049734",
        Email : "smail@mail.dz",
        created_at : ("2023-03-30T17:41:02.440Z")
    })
,
new Customer({
        ...
        created_at : ("2023-03-30T17:41:24.076Z")
    })
,
new Customer({
        ...
        created_at : ("2023-03-30T17:42:38.003Z")
    })
,
new Customer({
        ...
        created_at : ("2023-03-30T17:42:56.887Z")
    })
,
new Customer({
        ...
        created_at : ("2023-03-30T17:43:49.826Z")
    })
,
new Customer({
        ...
        created_at : ("2023-03-30T18:11:53.279Z")
    })
,
new Customer({
        ...
        created_at : ("2023-04-14T17:06:42.329Z")
    })
,
new Customer({
        ...
        Contact : "02152140211",
        Email : "karim@mail.dz",
        created_at : ("2023-04-15T16:36:43.689Z")
    })
,
new Customer({
        ...
        Contact : "02135545544",
        Email : "hakim@mail.dz",
        created_at : ("2023-04-16T13:59:14.863Z")
})
...
new booking({
        ...
        created_at : ("2023-04-17T14:32:38.467Z")
    })
    ,
    new booking({
        ...
        created_at : ("2023-04-17T14:31:30.795Z")        
    })
    ,
    new booking({
        ...
        created_at : ("2023-04-17T14:31:41.845Z")
    })
    ,
    new booking({
        ...
        created_at : ("2023-04-17T14:31:53.519Z")
    })
    ,
    new booking({
        ...
        created_at : ("2023-04-17T14:32:08.019Z")
    })
    ,
    new booking({
        ...
        created_at : ("2023-04-17T14:32:19.911Z")
    })
    ,
    new booking({
        ...
        created_at : ("2023-04-17T14:32:29.392Z")
    })
    ,
    new booking({
        ...
        created_at : ("2023-04-17T14:31:19.091Z")
})
...
let bills = [
    ...
    new Bill({
        ...
        CustomerID : "5e822fd59d92e605285b5396",
        created_at : ("2023-04-15T12:27:03.389Z")
    }),
    new Bill({
        ...
        created_at : ("2023-04-15T17:59:25.592Z")
    }),
    new Bill({
        ...
        CustomerID : "5e822f44b0f7790a685ac374",
        created_at : ("2023-04-15T19:41:03.714Z")
    }),
    new Bill({
        ...
        table_id : "5e87406389624917fc83db14",
        CustomerID : "5e97381b21b9df33a8e492b9",
        created_at : ("2023-04-16T13:31:41.371Z")
    }),
    new Bill({
        ...
        CustomerID : "5e9864b2b8ffe7594876d724",
        created_at : ("2023-04-17T09:29:50.809Z")
})
